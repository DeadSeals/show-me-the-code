...
public class Txt2xls {
    ...
    private static final String PATH = Txt2xls.class.getClassLoader().getResource("").getPath()+"r0014/";
    private static final String FILE_URL = PATH+"student.txt";
    private static final String XLS_URL = PATH+"test.xls";

    public static void main(String[] args) {
        String txtStr = loadTxtToString();
     ...
     * @return
     */
    private static String loadTxtToString(){
